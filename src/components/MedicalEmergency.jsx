...
const MedicalEmergency = () => {
    ...
    return ( 
        <div className="border h-screen px-4 flex flex-col  items-center">
            ...
            <button onClick={reportMedicine} className="rounded-lg bg-blue-600 hover:bg-blue-800 h-[20rem] w-[20rem] flex justify-center items-center shadow-xl cursor-pointer">
